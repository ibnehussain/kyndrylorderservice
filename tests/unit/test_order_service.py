...
class TestOrderService:
    ...
    async def test_create_order_success(
        self, order_service_with_mock_repo, mock_order_repository
    ):
        ...
        order_data = OrderCreate(
            ...
            billing_address=AddressSchema(
                street="123 Test St", city="Test City", state="TS", postal_code="12345"
            ),
            payment_info=PaymentInfoCreate(
                method="credit_card", last_four_digits="1234"
            ),
    ...
    async def test_get_order_success(
        self, order_service_with_mock_repo, mock_order_repository, sample_order
    ):
    ...
    async def test_get_order_not_found(
        ...
        mock_order_repository.get_by_id.assert_called_once_with(
            "nonexistent", "cust_456"
        )
    ...
    async def test_update_order_status(
        ...
        # Act
        result = await order_service_with_mock_repo.update_order(
            "order_123", "cust_456", update_data
        )
    ...
    async def test_cancel_order_success(
        ...
        # Act
        result = await order_service_with_mock_repo.cancel_order(
            "order_123", "cust_456"
        )
    ...
    async def test_delete_order_success(
        ...
        # Act
        result = await order_service_with_mock_repo.delete_order(
            "order_123", "cust_456"
        )
    ...
    async def test_get_order_by_number(
        ...
        # Act
        result = await order_service_with_mock_repo.get_order_by_number(
            "ORD-20260121-ABC123"
        )
        ...
        mock_order_repository.get_order_by_number.assert_called_once_with(
            "ORD-20260121-ABC123"
        )
    ...
    def test_calculate_order_totals(
        self, order_service_with_mock_repo, sample_order_items
    ):
